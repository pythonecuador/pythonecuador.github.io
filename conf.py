...
BLOG_AUTHOR = "Python Ecuador"  # (translatable)
...
PAGES = (
    ("pages/*.rst", "", "pagina.tmpl"),
    ("pages/*.md", "", "pagina.tmpl"),
    ("pages/*.txt", "", "pagina.tmpl"),
    ("pages/*.html", "", "pagina.tmpl"),
)
        ...
        <div class="text-center">
            ...
            <p>
                <small>
                    ...
                    <a href="https://pythonecuador.org/guias/colaborar/#reportando-errores-bugs" style="color:red;">¡Repórtalo!</a>
